...
import com.yebeisi.chip8.core.component.descriptor.instruction.RegistersOr;
...
@SpringBootTest
public class RegistersOrTest extends InstructionBaseTest{

    @Autowired
    private RegistersOr instruction;
    ...
    public void testExecute() {
        for(int x = 0; x <= 0xF; ++x) {
            for(int y = 0; y <= 0xF; ++y) {
                ...
                byte[] origins1 = new byte[] {0x00, 0x00, 0x00, 0x00, (byte) 0xF0};
                byte[] origins2 = new byte[] {0x00, 0x01, 0x10, (byte) 0xFF, 0x0F};
                byte[] expected = new byte[] {0x00, 0x01, 0x10, (byte) 0xFF, (byte) 0xFF};
