...
import com.yebeisi.chip8.core.component.descriptor.instruction.SkipIfNotPressed;
...
@SpringBootTest
public class SkipIfNotPressedTest extends InstructionBaseTest {

    @Autowired
    private SkipIfNotPressed instruction;
