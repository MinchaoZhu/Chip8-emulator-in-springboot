...
import com.yebeisi.chip8.core.component.descriptor.instruction.SkipRegisterConstNotEquals;
...
@SpringBootTest
public class SkipRegisterConstNotEqualsTest extends InstructionBaseTest{

    @Autowired
    private SkipRegisterConstNotEquals instruction;
